...
function TabsRoot({
  ...
  return (
    <Tabs.Root className={twMerge(["cosmic-tabs", className])} {...rest}>
      {children}
    </Tabs.Root>
  );
}
...
function TabsList({
  ...
  return (
    <Tabs.List className={twMerge(["cosmic-tabs-list", className])} {...rest}>
      {children}
    </Tabs.List>
  );
}
...
function TabsTrigger({
  ...
  return (
    <Tabs.Trigger asChild {...rest}>
      {!asChild ? (
        <Button
          className={twMerge(["cosmic-tabs-trigger", className])}
          customPaths={[
...
function TabsContent({
  ...
  return (
    <Tabs.Content className={twMerge(["cosmic-tabs-content", className])} {...rest}>
      <Frame
        paths={JSON.parse(
