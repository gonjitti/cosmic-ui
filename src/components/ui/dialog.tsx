...
function DialogBackdrop({
  ...
  return (
    <Dialog.Backdrop className={twMerge(["cosmic-dialog-backdrop", className])} {...rest} />
  );
}
...
function DialogContent({
  ...
  return (
    <Dialog.Content className={twMerge(["cosmic-dialog-content", className])} {...rest}>
      <Frame
        className="cosmic-dialog-frame"
        paths={JSON.parse(
...
function DialogTitle({
  ...
  return (
    <Dialog.Title className={twMerge(["cosmic-dialog-title", className])} {...rest}>
      {children}
    </Dialog.Title>
  );
}
...
function DialogDescription({
  ...
  return (
    <Dialog.Description className={twMerge(["cosmic-dialog-description", className])} {...rest}>
      {children}
    </Dialog.Description>
  );
}
  ...
  return (
    <Dialog.CloseTrigger asChild {...rest}>
      {!asChild ? (
        <Button
          shape="flat"
          className={twMerge(["cosmic-dialog-close", className])}
          {...rest}
        >
          <X className="size-4" />
        </Button>
